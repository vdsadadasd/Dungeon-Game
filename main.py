    ...
    def start(self):
        ...
        while True:
            ...
            if move in ["W", "A", "S", "D"]:
                ...
                self.slow_text("Objective: Escape the dungeon by defeating the Guardian.", 0.01)
                self.slow_text("You can move using W (up), A (left), S (down), D (right).", 0.01)
                self.slow_text("Pick up the Bow and Arrow to fight the Guardian.", 0.01)
                self.slow_text("You can attack the Guardian directly, but it's risky.", 0.01)
                self.slow_text("Hint: If you have a Bow and Arrow, you can shoot the Guardian from a neighboring room to instantly defeat it.", 0.01)
                self.slow_text("Use 'U' to use items from your inventory by typing out what you want to use", 0.01)
                self.slow_text("If you see 'You hear it...', 'Footsteps approach...', 'Something is nearby...' that means the guardian is in a neighboring room", 0.01)
                self.slow_text("Defeat the Guardian before it defeats you!", 0.01)
                self.slow_text("=========================", 0.01)
                self.slow_text("Press Enter to continue...", 0.01)
                input()
